...
CKEDITOR.dialog.add("base64imageDialog", function(editor){
	...
	var t = null,
		selectedImg = null, wirisContent = null,
  ...
  if(selectedImg) {
    ...
    wirisContent = selectedImg ? selectedImg.getAttribute('data-mathml') : null;
  }
  if(!selectedImg || selectedImg.getName() !== "img") selectedImg = null;
    ...
    return {
      ...
      // 公式编辑时图像常规标签不可切换
      t._.tabs['tab-source'][0].setStyle('display', wirisContent ? 'none' : 'inline-block')
