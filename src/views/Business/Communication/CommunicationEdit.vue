  ...
  <main class="commeditor" v-if="preConfig">
    ...
    >
      ...
      >
        ...
        <Col class="commeditor--contents__detail" span="20">
          {{item.content}}
        </Col>
...
export default {
  ...
  methods: {
    ...
    addLog(name) {
      ...
      this.fdata.communication_logs.unshift(comm_log)
    ...
    handleLog() {
      ...
      if (communication_at !== '' || content !== '') {
        valid = this.beforeAddLog('comm_log')
      }
