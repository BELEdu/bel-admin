<template>
  <div class="home">
                ...
                <div class="home-header__campus">
                  ...
                  <Dropdown trigger="click" placement="bottom-start" @on-click="switchCampus">
                    ...
                    <Dropdown-menu slot="list">
                      <Dropdown-item
                        v-for="(list, index) in homeData.campus_list"
                        :key="list.value"
                        :name="index"
                      >{{list.display_name}}</Dropdown-item>
                    </Dropdown-menu>
                  </Dropdown>]
                </div>
              </Col>
                  ...
                  <table class="home-header__table-content">
                    ...
                    <tbody>
                      <tr>
                        <td>签约单数</td>
                        <td>
                          <div class="home-header__table-cell-val">1</div>
                        </td>
                        <td>
                          <div class="home-header__table-cell-val">344</div>
                        </td>
                        <td>
                          <div class="home-header__table-cell-val">520</div>
                        </td>
                      </tr>
                      <tr>
                        <td>签约金额</td>
                        <td>
                          <div class="home-header__table-cell-val">5,873.00元</div>
                        </td>
                        <td>
                          <div class="home-header__table-cell-val">1,923,882.00元</div>
                        </td>
                        <td>
                          <div class="home-header__table-cell-val">3,223,768.00元</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table class="home-header__table-content">
                    ...
                    <tbody>
                      <tr>
                        <td>耗课课时数</td>
                        <td>
                          <div class="home-header__table-cell-val">1250</div>
                        </td>
                        <td>
                          <div class="home-header__table-cell-val">2011</div>
                        </td>
                      </tr>
                      <tr>
                        <td>耗课金额</td>
                        <td>
                          <div class="home-header__table-cell-val">923,882.00元</div>
                        </td>
                        <td>
                          <div class="home-header__table-cell-val">2,123,768.00元</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
    ...
    <home-module :data="homeData.module" class-name="home-waterfall"></home-module>
  </div>
</template>
